...
const normalizeAppMode = (value: string | undefined): AppMode => {
  ...
  if (normalized === "test" || normalized === "ci") {
    return "test"
  }
...
export const APP_MODE = normalizeAppMode(optional("APP_MODE", TFB_RUNTIME_ENV || NODE_ENV))
export const IS_PRODUCTION_APP_MODE = APP_MODE === "prod"
export const IS_NON_PRODUCTION_APP_MODE = !IS_PRODUCTION_APP_MODE
const isDev = IS_NON_PRODUCTION_APP_MODE

const ENABLED_ENV_VALUES = new Set(["1", "true", "yes", "on"])

export const isEnabledEnvValue = (value: string | undefined) => ENABLED_ENV_VALUES.has(value?.trim().toLowerCase() ?? "")
...
export const PREVIEW_LOGIN_REQUIRE_SIGNATURE = optional("PREVIEW_LOGIN_REQUIRE_SIGNATURE")
...
// 微信服务号 OAuth（Medusa Auth provider canonical names）
export const WECHAT_MP_APP_ID = optional("WECHAT_MP_APP_ID", WECHAT_SERVICE_APP_ID)
export const WECHAT_MP_APP_SECRET = optional("WECHAT_MP_APP_SECRET", WECHAT_SERVICE_APP_SECRET)
export const WECHAT_MP_CALLBACK_URL = optional("WECHAT_MP_CALLBACK_URL", WECHAT_SERVICE_LOGIN_REDIRECT_URL)
export const WECHAT_MP_SCOPE = optional("WECHAT_MP_SCOPE", "snsapi_base")
...
// 微信支付
export const WECHAT_PAY_MCH_ID = optional("WECHAT_PAY_MCH_ID") || optional("WECHAT_PAY_MCHID")
export const WECHAT_PAY_APP_ID = optional("WECHAT_PAY_APP_ID") || optional("WECHAT_PAY_APPID", WECHAT_MP_APP_ID)
...
export const WECHAT_PAY_MERCHANT_SERIAL_NO = optional("WECHAT_PAY_MERCHANT_SERIAL_NO") || optional("WECHAT_PAY_CERT_SERIAL_NO")
export const WECHAT_PAY_PRIVATE_KEY_PEM = optional("WECHAT_PAY_PRIVATE_KEY_PEM") || optional("WECHAT_PAY_PRIVATE_KEY")
export const WECHAT_PAY_PUBLIC_KEY_PEM = optional("WECHAT_PAY_PUBLIC_KEY_PEM") || optional("WECHAT_PAY_PLATFORM_PUBLIC_KEY")
...
export const TEST_CUSTOMER_EMAIL = optional("TEST_CUSTOMER_EMAIL") || optional("PREVIEW_TEST_CUSTOMER_EMAIL") || (isDev ? DEFAULT_TEST_CUSTOMER_EMAIL : "")
export const TEST_CUSTOMER_PASSWORD = optional("TEST_CUSTOMER_PASSWORD") || optional("PREVIEW_TEST_CUSTOMER_PASSWORD") || (isDev ? DEFAULT_TEST_CUSTOMER_PASSWORD : "")
...
export function logEnvSummary() {
  const vars: Array<{
    ...
    {
      key: "COOKIE_SECRET",
      value: COOKIE_SECRET ? "***" : "MISSING",
      source: "required",
    },
    { key: "MEDUSA_FILE_URL", value: MEDUSA_FILE_URL, source: "required" },
    {
      key: "MEDUSA_FILE_ACCESS_KEY_ID",
      value: MEDUSA_FILE_ACCESS_KEY_ID ? "***" : "MISSING",
      source: "required",
    },
    {
      key: "MEDUSA_FILE_SECRET_ACCESS_KEY",
      value: MEDUSA_FILE_SECRET_ACCESS_KEY ? "***" : "MISSING",
      source: "required",
    },
    {
      key: "MEDUSA_FILE_REGION",
      value: MEDUSA_FILE_REGION,
      source: "required",
    },
    {
      key: "MEDUSA_FILE_BUCKET",
      value: MEDUSA_FILE_BUCKET,
      source: "required",
    },
    {
      key: "MEDUSA_FILE_ENDPOINT",
      value: MEDUSA_FILE_ENDPOINT,
      source: "required",
    },
    {
      key: "MEDUSA_FILE_PREFIX",
      value: MEDUSA_FILE_PREFIX,
      source: "optional",
    },
    { key: "WORKER_MODE", value: WORKER_MODE, source: "optional" },
    { key: "APP_MODE", value: APP_MODE, source: "optional" },
    {
      key: "TFB_RUNTIME_ENV",
      value: TFB_RUNTIME_ENV || "(unset)",
      source: "optional",
    },
    {
      key: "PREVIEW_PAYMENT_MODE",
      value: PREVIEW_PAYMENT_MODE || "(unset)",
      source: "optional",
    },
    {
      key: "PREVIEW_LOGIN_SECRET",
      value: PREVIEW_LOGIN_SECRET ? "***" : "(unset)",
      source: "optional",
    },
    {
      key: "PREVIEW_LOGIN_REQUIRE_SIGNATURE",
      value: PREVIEW_LOGIN_REQUIRE_SIGNATURE || "(unset)",
      source: "optional",
    },
    {
      key: "RESEND_API_KEY",
      value: RESEND_API_KEY ? "***" : "(unset)",
      source: "optional",
    },
    {
      key: "NOTION_TOKEN",
      value: NOTION_TOKEN ? "***" : "(unset)",
      source: "optional",
    },
    {
      key: "WECHAT_SERVICE_APP_ID",
      value: WECHAT_SERVICE_APP_ID || "(unset)",
      source: "optional",
    },
    {
      key: "WECHAT_MP_APP_ID",
      value: WECHAT_MP_APP_ID || "(unset)",
      source: "optional",
    },
    {
      key: "WECHAT_PAY_MCH_ID",
      value: WECHAT_PAY_MCH_ID || "(unset)",
      source: "optional",
    },
    {
      key: "WECHAT_PAY_APP_ID",
      value: WECHAT_PAY_APP_ID || "(unset)",
      source: "optional",
    },
  ]
